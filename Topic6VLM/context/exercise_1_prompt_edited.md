...
Most models will resize and format images internally. For now there is not need to alter the image being sent to the model. Most likely it will need to be packaged as expected by langgaph and the model api.
