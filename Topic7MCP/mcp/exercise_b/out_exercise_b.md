...
- Inner Speech: Development, Cognitive Functions, Phenomenology, and Neurobiology (Unknown year)
- Internet-augmented language models through few-shot prompting for open-domain question answering (Unknown year)
- Keep CALM and Explore: Language Models for Action Generation in Text-based Games (Unknown year)
- L.S. Vygotsky and the problem of localization of functions (Unknown year)
- LILA: Language-Informed Latent Actions (Unknown year)
- Language Models are Few-Shot Butlers (Unknown year)
- Language Models are Few-Shot Learners (Unknown year)
- Language Models as Zero-Shot Planners: Extracting Actionable Knowledge for Embodied Agents (Unknown year)
