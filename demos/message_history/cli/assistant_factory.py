...
from open_ai_assistant import OpenAIAssistantTrimMessages, OpenAIAssistant
...
class AgentFactory:
    ...
    _agent_dict = {
        ...
        "openai_trim":   OpenAIAssistantTrimMessages,
    }
    ...
    def create_agent(agent_type: str, model_name: str = None) -> Assistant:
        ...
        elif agent_type.lower() == "openai_trim":
            return OpenAIAssistantTrimMessages()
        else:
